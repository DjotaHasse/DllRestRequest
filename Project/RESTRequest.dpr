...
function Put(prHost, prResource: WideString; var prParams: TParams; var prProperties: TProperties; var prBody: TBody): TRESTResponse; stdcall;
var
  i: Integer;
  wUTF8String: UTF8String;
begin
...
function Delete(prHost, prResource: WideString; var prParams: TParams; var prProperties: TProperties): TRESTResponse; stdcall;
var
  i: Integer;
begin
  fRESTRequest := TRESTRequest.Create(nil);
...
function Patch(prHost, prResource: WideString; var prParams: TParams; var prProperties: TProperties; var prBody: TBody): TRESTResponse; stdcall;
var
  i: Integer;
  wUTF8String: UTF8String;
begin
